...
def test_api_session_redacts_messages():
    ...
    # WHY: byte admission now wraps the dispatcher; verify the actual producer
    # still redacts before bytes can enter the 09-01/02 OOM-prevention cache.
    src = inspect.getsource(routes._handle_get_impl)
