...
# WHY: refresh no faster than the 5s polling floor, avoiding 09-03's
# recompute/throttle/retry overlap. Committed mutations still invalidate.
_SESSIONS_CACHE_TTL_SECONDS = 5.0
